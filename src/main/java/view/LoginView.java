...
public class LoginView extends JFrame implements ActionListener {
    ...
    private void initComponents() {
        ...
        logoLabel = new JLabel("Đặt vé online");
        ...
        panel.add(loginBtn);
        panel.add(logoLabel);
        logoLabel.setFont(new java.awt.Font("Segoe UI", 3, 22));
        logoLabel.setForeground(new java.awt.Color(255, 0, 0));
        logoLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        logoLabel.setIcon(new javax.swing.ImageIcon("C:\\Users\\nddh2\\Downloads\\tải xuống (1).png"));
        ...
        layout.putConstraint(SpringLayout.NORTH, logoLabel, 40, SpringLayout.NORTH, panel);
